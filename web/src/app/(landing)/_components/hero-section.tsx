    ...
    <section className="flex w-full max-w-4xl flex-col-reverse items-center justify-between md:flex-row md:space-x-8">
      ...
      <div className="group relative mt-24 h-72 cursor-pointer space-y-3 md:mt-0 md:w-72">
        <div className="flex gap-5">
          <div className="duration-4000 h-24 w-24 rounded-2xl bg-primary animate-in slide-in-from-top-12 md:h-32 md:w-32" />
          <div className="duration-4000 h-24 w-24 rounded-full bg-secondary animate-in slide-in-from-right-12 md:h-32 md:w-32" />
        </div>
        <div className="flex gap-5">
          <div className="duration-4000 h-24 w-24 rounded-full bg-secondary animate-in slide-in-from-left-12 md:h-32 md:w-32" />
          <div className="duration-4000 h-24 w-24 rounded-2xl bg-primary animate-in slide-in-from-bottom-12 md:h-32 md:w-32" />
        </div>
